...
E3 = [1, 0.2; 0, 1];
tsam3 = 0.01;
[sys3, e3] = dss(A3, B3, C3, D3, E3, tsam3);
disp("test case 3: ");
disp(sys3);
disp("E matrix:");
disp(e3);
...
E6 = [2, 0; 0, 1];
tsam6 = 0.1;
[sys6, e6] = dss(A6, B6, C6, D6, E6, tsam6);
disp("test case 6: ");
disp(sys6);
disp("E matrix:");
disp(e6);
...
E7 = [1, 0.5; 0, 1];
tsam7 = 0.05;
[sys7, e7] = dss(A7, B7, C7, D7, E7, tsam7);
disp("test case 7: ");
disp(sys7);
disp("E matrix:");
disp(e7);
